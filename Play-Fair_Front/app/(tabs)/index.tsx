    ...
    <SafeAreaProvider>
      <SafeAreaView style={styles.container}>
        <ScrollView contentContainerStyle={styles.scrollContent}>
          ...
          {/* HEADER (On peut aussi en faire un composant à part si on veut) */}
          ...
          {/* GROSSE CARTE D'ACTION */}
          <View style={styles.actionCardWrapper}>
              <View style={styles.actionCardShadow} />
              <View style={styles.actionCardContent}>
                
                {/* Utilisation du composant réutilisable NeoButton */}
                <NeoButton 
...
// Styles restants (uniquement pour la mise en page globale de App.js)
const styles = StyleSheet.create({
  ...
  avatarContainer: {
    width: 120, height: 120, borderRadius: 60, backgroundColor: '#A78BFA',
    justifyContent: 'center', alignItems: 'center', borderWidth: 3, borderColor: 'black',
    // Ombre Avatar
    shadowColor: "#000", shadowOffset: { width: 5, height: 5 },
    shadowOpacity: 1, shadowRadius: 0, elevation: 10, marginBottom: 15,
  },
  username: { fontSize: 28, fontWeight: '900', color: 'black' },

  // Styles de la grande carte (Conteneur des boutons)
  ...
  actionCardShadow: {
    ...
    backgroundColor: '#6EE7B7', borderRadius: 20, borderWidth: 3, borderColor: 'black',
  },
  actionCardContent: {
    width: '100%', height: '100%', backgroundColor: 'white', borderRadius: 20,
    borderWidth: 3, borderColor: 'black', flexDirection: 'row',
